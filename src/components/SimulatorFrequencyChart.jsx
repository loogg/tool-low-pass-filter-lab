    ...
    return {
      ...
      tooltip: {
        ...
        axisPointer: {
          ...
          label: { color: '#082829', backgroundColor: GAIN_COLOR, fontSize: 9 },
        },
        padding: 0,
        borderWidth: 0,
        backgroundColor: 'transparent',
      ...
      yAxis: [
        {
          type: 'value',
          name: 'MAGNITUDE / dB',
          nameTextStyle: { color: GAIN_COLOR, fontSize: 8, padding: [0, 0, 4, 0] },
          min: response.gainDomain[0],
          max: response.gainDomain[1],
          position: 'left',
          axisLine: { show: true, lineStyle: { color: 'rgba(215,245,109,0.38)' } },
          axisTick: { show: false },
          axisLabel: { color: GAIN_COLOR, fontSize: 9, formatter: (value) => `${formatNumber(value, 0)} dB` },
        ...
        },
        {
          type: 'value',
          name: 'PHASE / °',
          nameTextStyle: { color: PHASE_COLOR, fontSize: 8, padding: [0, 0, 4, 0] },
          min: -92,
          max: 2,
          position: 'right',
          axisLine: { show: true, lineStyle: { color: 'rgba(25,200,193,0.42)' } },
          axisTick: { show: false },
          axisLabel: { color: PHASE_COLOR, fontSize: 9, formatter: (value) => `${formatNumber(value, 0)}°` },
      ...
      dataZoom: [
        { type: 'inside', xAxisIndex: 0, filterMode: 'none' },
        {
          ...
          textStyle: { color: '#66867e', fontSize: 8 },
        },
      ],
      series: [
        {
